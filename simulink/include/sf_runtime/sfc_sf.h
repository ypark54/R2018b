...
LIBMWSF_RUNTIME_API void sf_call_output_fcn_disable(SimStruct* S,
                                                    ...
                                                    const char* eventName,
                                                    int checkForInitialization);
LIBMWSF_RUNTIME_API void sf_set_rtw_dwork_info(SimStruct* S,
                                               const char* spec,
                                               mxArray* infoStruct,
...
LIBMWSF_RUNTIME_API void setDataBrowseFcnForRuntime(SimStruct* S, void* aFcn);
LIBMWSF_RUNTIME_API void setLegacyDebuggerFlagForRuntime(SimStruct* S, bool aFlag);
...
typedef enum { SF_MSG_SEND_OK = 0, SF_MSG_SEND_HAS_OVERFLOW = 0x01 } SFMsgSendStatus;
