...
;size_t mPartitionMemoryBudget;};typedef enum NeEquationDomainTag{
...
extern "C" {
#endif /* __cplusplus */
const McLinearAlgebraFactory*mc_get_csparse_linear_algebra(void);PmfMessageId
ne_dae_create(NeDae**dae,NeDynamicSystem*dynamicsystemPtr,NeSolverParameters
