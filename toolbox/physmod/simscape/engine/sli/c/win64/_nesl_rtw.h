...
NeObservableDataTag{const char*mFullPath;const char*mObject;size_t mM;size_t mN
...
mICValue;const char*mDescription;}NeModeData;typedef enum NeRangeTypeIdTag{
...
mDescription;size_t mIndex;size_t mM;}NeParameterData;typedef enum
...
NeModelParameters*mp,NeuDiagnosticManager*mgr);const NeslContLtiData*(*
mGetContLtiData)(const NeslSimulator*s);const SLMatrices**(*mGetSLMatrices)(
const NeslSimulator*s);void(*mDestroy)(NeslSimulator*);NeCustomData*(*
...
NE_PARTITIONING_EXHAUSTIVE,NE_PARTITIONING_NUM}NePartitionStorageMethod;struct
...
;size_t mPartitionMemoryBudget;};typedef struct NeOutputParametersTag{size_t
mDaeIndex;size_t mOutputFunctionIndex;}NeOutputParameters;typedef enum
...
];};typedef struct NeDaeTag NeDae;PmfMessageId nesl_register_simulator_group(
const char*key,const size_t numDae,NeDae*const*dae,const NeSolverParameters*sp
,const NeModelParameters*mp,const size_t numOutputs,const NeOutputParameters*
op);typedef struct NeslSimulatorGroupRegistryTag NeslSimulatorGroupRegistry;
...
nesl_get_registry(void);int_T pm_create_sparsity_pattern_fields(
...
mNumParamAssertRanges;size_t mNumRanges;size_t mNumEquationRanges;size_t
...
NeRange*mAssertRanges;NeAssertData*mParamAssertData;NeRange*mParamAssertRanges
;NeRange*mRanges;NeRange*mEquationRanges;NeParameterData*mLogicalParameters;
NeParameterData*mIntegerParameters;NeParameterData*mIndexParameters;
NeParameterData*mRealParameters;void*mLargeArrayData;NeDsGenerateFcn
mGenerateFcn;NeDsCreateDsFcn mDiagnosticsDsFcn;NeDsExpandFcn mExpandFcn;
...
extern "C" {
#endif /* __cplusplus */
PmAllocator*pm_default_allocator(void);struct LtiIcDataTag{PmSparsityPattern
mStatesPattern;PmRealVector mStatesPr;PmSparsityPattern mInputsPattern;
PmRealVector mInputsPr;PmRealVector mConsts;};typedef struct LtiIcDataTag
LtiIcData;struct LtiDcDataTag{PmSparsityPattern mAPattern;PmRealVector mAPr;
PmSparsityPattern mBPattern;PmRealVector mBPr;PmRealVector mFa;};typedef struct
LtiDcDataTag LtiDcData;struct LtiIcParamsTag{LtiIcData mFirstSolve,
mSecondSolve;LtiDcData mDcSolve;PmRealVector mGuess;real_T mResTol;boolean_T
mDoDC;};typedef struct LtiIcParamsTag LtiIcParams;typedef void(*
LtiDiagnosisMethod)(void*,PmCharVector);typedef struct LtiSupportMethodsTag{
void*mLtiDiagnosisData;LtiDiagnosisMethod mIcDiagnosisMethod;
LtiDiagnosisMethod mDcDiagnosisMethod;}LtiSupportMethods;boolean_T
ic_solve_impl(PmRealVector*x,const PmRealVector*u,const LtiIcParams*
...
extern "C" {
#endif /* __cplusplus */
typedef enum{INVALID_CARDINALITY= -1,SWL_UNCOUNTABLE,SWL_COUNTABLE,SWL_FINITE,
...
PmRealVector mY;PmIntVector mASSERT;PmRealVector mINIT_R;PmIntVector mINIT_I;
PmRealVector mCACHE_R;PmIntVector mCACHE_I;PmRealVector mUPDATE_R;PmIntVector
mUPDATE_I;PmIntVector mDP_L;PmIntVector mDP_I;PmIntVector mDP_J;PmRealVector
mDP_R;PmRealVector mINIT_DIFF;}GmtMethodOutput;typedef enum GmtMethodIdTag{
GMT_INVALID_METHOD_ID= -1,GMT_METHOD_MODE,GMT_METHOD_Y,GMT_METHOD_ASSERT,
GMT_METHOD_INIT_R,GMT_METHOD_INIT_I,GMT_METHOD_CACHE_R,GMT_METHOD_CACHE_I,
GMT_METHOD_UPDATE_R,GMT_METHOD_UPDATE_I,GMT_METHOD_DP_L,GMT_METHOD_DP_I,
...
mMethods[GMT_NUM_METHODS];size_t mNumY;size_t mNumAssertions;const NeAssertData
*mAssertData;size_t mNumRanges;const NeRange*mRanges;NeParameterInfo
mParameterInfo;PmIntVector*mModeIndices;};typedef struct SwitchedLinearClumpTag
SwitchedLinearClump;typedef union SlcMethodOutputTag{PmSparsityPattern mM_P;
PmRealVector mM;PmSparsityPattern mJ_P;PmRealVector mJ;PmRealVector mF;
...
void(*mDestroy)(SwitchedLinearSystem*sls);};typedef struct SimulatorTag
Simulator;typedef struct SimulatorDataTag SimulatorData;struct SimulatorTag{
size_t mNumInputs;size_t mNumStates;size_t mNumOutputs;double mStepSize;const
NeParameterInfo*mParameterInfo;SimulatorData*mData;const PmSizeVector*
mMemEstimates;boolean_T(*mStart)(const Simulator*solver,const NeParameterBundle
*bundle);NeDynamicSystemInput(*mGetDsi)(const Simulator*simulator,const
PmRealVector*inputs,const PmRealVector*states,real_T time);boolean_T(*mSolve)(
const Simulator*solver,const PmRealVector*inputs,const PmRealVector*states,
const PmRealVector*outputs,real_T time,const NeuDiagnosticManager*mgr,
...
NeuDiagnosticManager*mgr);void(*mDestroy)(Simulator*solver);};Simulator*
simulator_create(SwitchedLinearSystem*sls,const NeSolverParameters param,const
McLinearAlgebraFactory*la);
#ifdef __cplusplus
}
#endif /* __cplusplus */
