...
NeCustomData;typedef struct NeDaeTag NeDae;typedef struct NeRealFunctorDataTag
NeRealFunctorData;typedef struct NeRealFunctorTag NeRealFunctor;typedef enum
...
PmBoolVector mDXF_V_X;PmBoolVector mDUF_V_X;PmRealVector mOBS_EXP;PmRealVector
mEQ_TOL;}NeDaeMethodOutput;typedef enum NeDaeMethodIdTag{
